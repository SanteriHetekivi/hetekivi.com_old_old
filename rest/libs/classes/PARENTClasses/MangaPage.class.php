...
class MangaPage
{
	...
	function __construct($page = FALSE, $included = FALSE, $excluded = FALSE, $completed = TRUE, $minChapters = false, $maxChapters = false, $pageNo = false)
	{
		if($page) $this->setPage($page);
		if($included) $this->setIncluded($included);
		if($excluded) $this->setExcluded($excluded);
	...
	public function setExcluded($excluded)  { $this->_excluded = (is_array($excluded))?$excluded:Array(); }

	public function getExcluded() {return $this->_excluded;}
